...
ARG KERNEL_VERSION="${KERNEL_VERSION:-6.15.4-104.bazzite.fc42.x86_64}"
...
FROM ghcr.io/ublue-os/bluefin-dx-nvidia-open:${FEDORA_VERSION} AS bazzite
...
RUN --mount=type=cache,dst=/var/cache \
    ...
    rpm --import https://repos.fyralabs.com/terra42-mesa/key.asc && \
